...
def create_finegates(um, p):
    ...
    dualplungers = create_qpc(0.9*lgate+p.qpcwidth-2*p.finegatewidth, height_gate = p.finegatewidth, length_gate= 0.5*p.gate_separation-0.5*(2*lgate+p.qpcwidth-2*p.finegatewidth))
