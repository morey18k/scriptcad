...
import klayout.lib
import math
from bowtieNoMesa.mesa_dot import make_mesa_1, make_mesaf_1
from bowtieNoMesa.ohmics_dot import make_ohmics_1, make_island_1
from bowtieNoMesa.gates import create_finegates, create_gatepads

# Creating layout and top cells


def create_bowtieNoMesa(p, um):
