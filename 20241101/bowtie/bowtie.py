...
import klayout.lib
import math
from bowtie.mesa_dot import make_mesa_1, make_mesaf_1
from bowtie.ohmics_dot import make_ohmics_1, make_island_1
from bowtie.gates import create_finegates, create_gatepads

# Creating layout and top cells

def create_bowtie(p, um):
